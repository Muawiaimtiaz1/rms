...
router.get("/", requireAuth, async (req, res) => {
  try {
    ...
    const query = `SELECT id, name, logo_path, receipt_header_text, receipt_extended_name, receipt_phone, receipt_address, 
                ...
                divider_style, divider_width, section_gap, auto_calculate_damage_to_loss, bill_printer
...
router.post("/", requireAuth, requireAdmin, upload.single("logo"), async (req, res) => {
  try {
    ...
    const fields = [
      ...
      "footer_margin", "divider_style", "divider_width", "section_gap", "auto_calculate_damage_to_loss", "bill_printer"
    ];
